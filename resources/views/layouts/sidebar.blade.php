  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="{{ route('admin.paket-layanan.index') }}" class="nav-link">
            <i class="nav-icon fas fa-chart-bar"></i>
            <p>
              Paket Layanan
            </p>
        ...
        <li class="nav-item">
          <a href="{{ route('admin.permintaan.index') }}" class="nav-link">
            <i class="nav-icon fas fa-chart-bar"></i>
            <p>
              Permintaan
            </p>
        ...
        <li class="nav-item">
          <a href="{{ route('admin.user-permana-home-number.index') }}" class="nav-link">
            <i class="nav-icon fas fa-chart-bar"></i>
            <p>
